...
export default function OpportunityEngine() {
  ...
  return (
    <DentistLayout title="Marketplace">
      {/* Header Section */}
      <div className="mb-10 flex flex-col md:flex-row justify-between items-end gap-6">
        ...
        <button className="primary-gradient text-white px-8 py-4 rounded-xl font-bold uppercase tracking-widest shadow-lg shadow-primary/20 hover:scale-[1.02] transition-all">
          Post Gig
        </button>
      </div>
