...
export default function LandingPage({ onGetStarted }: LandingProps) {
  return (
    <div className="bg-surface font-body text-on-surface selection:bg-primary-container selection:text-on-primary-container">
      ...
      <section className="page-shell page-padding pt-30 md:pt-36 pb-16 md:pb-20">
        <div className="rounded-[2rem] border border-primary/10 bg-gradient-to-b from-primary-fixed/20 to-surface-container-lowest px-6 py-10 md:px-12 md:py-14 lg:px-16 lg:py-16">
          <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-end">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[['4.9/5', 'Clinician Satisfaction'], ['140+', 'Active Gig Types'], ['48h', 'Avg. Verification Time'], ['24/7', 'Global Opportunity Flow']].map(([value, label]) => (
                <div key={label} className="rounded-2xl bg-white/80 border border-outline-variant/20 p-5">
      ...
      <section id="features" className="page-shell page-padding py-20 md:py-28" >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start">
          <div id="about" className="sticky top-26">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {FEATURES.map((f) => (
              <div key={f.title} className="bg-surface-container-lowest p-7 rounded-3xl editorial-shadow border border-outline-variant/10 hover:border-primary/20 transition-all group">
      ...
      <section id="pricing" className="bg-inverse-surface py-20 md:py-28 page-padding">
